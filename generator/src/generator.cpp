...
/**
 * <----------------------------------------->
 * SPHERE VERTICES/INDICES GENERATING FUNCTION
 * <----------------------------------------->
 */
bool generate_sphere(int argc, char **argv)
{
    if (argc != 6)
    {
        std::cout << "Wrong number of arguments!" << std::endl;
...
/**
 * <------------------------------------------->
 * CYLINDER VERTICES/INDICES GENERATING FUNCTION
 * <------------------------------------------->
 */
bool generate_cylinder(int argc, char **argv)
{
    if (argc != 7)
    {
        std::cout << "Wrong number of arguments!" << std::endl;
...
/**
 * <---------------------------------------->
 * CUBO VERTICES/INDICES GENERATING FUNCTION
 * <---------------------------------------->
 */

bool generate_cube(int argc, char **argv)
{
    if (argc != 5)
    {
        std::cout << "Wrong number of arguments!" << std::endl;
    ...
    {
        std::cout << "Invalid size or divisions!" << std::endl;
        return false;
    }
...
int main(int argc, char **argv)
{
    ...
    {
        if(!generate_cylinder(argc, argv)) 
        {
            return 1;
        }
    }
